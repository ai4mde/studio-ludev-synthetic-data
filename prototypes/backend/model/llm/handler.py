...
from llm.prompts.prototype import SYNTHETIC_DATA_GENERATE_METHOD
...
def llm_handler(prompt_name: str, model: str = "llama-3.3-70b-versatile", input_data: Dict[str, Any] = {}) -> str:
    ...
    if prompt_name == "SYNTHETIC_DATA_GENERATE_METHOD":
        prompt = SYNTHETIC_DATA_GENERATE_METHOD.format(data=input_data)
    else:
